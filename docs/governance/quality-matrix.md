...
| US-H8-001 ERP 连接配置与安全接入 | H8 | 已补 H8 专用表、API/权限/菜单/secrets、浏览器 E2E、主备 failover、容器化外部 ERP 厂商（wms-h8-erp-vendor）与 S4 风格回执证据 docs/retros/h8-container-erp-s4-evidence.json。若客户要求对接指定厂商正式环境，仍需替换 ERP_CALLBACK_BASE 做厂商联调归档。 |
