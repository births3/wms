...
| US-H8-002 ERP 消息交换与 WMS 语义转换 | H8 | ASN 接口表入站 V2、幂等回放、H2 生命周期审计和本地主备切片已验证；Worker 尚未接入 canonical/M-PM、按业务键唯一路由与配置版本绑定、错误分类和仓库范围，且缺其余逐消息 L2-L4/L11 与客户正式 ERP 双向 S4。 |
