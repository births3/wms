...
| US-H8-004 ERP 接口表只读探查 | H8 | 产品决策与十轮规格已闭合（专用权限、独立菜单、独立探查凭据及版本、SELECT-only 账号、无仓表全仓权限、脱敏限长摘要、详情联合键、updated_at、表级过滤 400、Docker 关软件路径）。连接字段迁移、API、权限迁移、页面 E2E 与截图均未落地；页面未实现前不预登记 frontend_pages 或空 E2E 证据。 |
