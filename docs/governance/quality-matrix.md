...
| US-H8-001 ERP 连接配置与安全接入 | H8 | US-H8-001 AC1-16 配置/运行时主链已实现：route-resolve、scope、幂等/乐观锁、在途 pause/resume、测试重叠校验、熔断半开证据、E2E 6 条。唯一可选延期：客户指定厂商正式 ERP 回执（ERP_CALLBACK_BASE）。 |
