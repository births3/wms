...
| [domain/user-stories-h8-erp-integration.md](domain/user-stories-h8-erp-integration.md) | H8 ERP 防腐层 |
...
| [reviews/m2-overall-review-2026-07-18.md](reviews/m2-overall-review-2026-07-18.md) | M2 入库模块整体审查、故事真实状态、阻断缺口与恢复条件 |
...
| [runbooks/local-dev-services.md](runbooks/local-dev-services.md) | 本地宿主机应用服务常驻与源码自动重启 |
