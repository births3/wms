...
error_codes:
  ...
  - code: M1_LPN_DUPLICATE
    module: M1
    category: LPN
    detail: DUPLICATE
    http_status: 409
    severity: warning
    message_zh: '同一货主的 LPN 码已存在'
    message_en: 'LPN code already exists for this owner'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_TYPE_INVALID
    module: M1
    category: LPN
    detail: TYPE_INVALID
    http_status: 422
    severity: warning
    message_zh: 'LPN 容器类型非法'
    message_en: 'LPN container type is invalid'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_CODE_EMPTY
    module: M1
    category: LPN
    detail: CODE_EMPTY
    http_status: 422
    severity: warning
    message_zh: 'LPN 码不能为空'
    message_en: 'LPN code is empty'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_CODE_TOO_LONG
    module: M1
    category: LPN
    detail: CODE_TOO_LONG
    http_status: 422
    severity: warning
    message_zh: 'LPN 码长度必须为 1-64'
    message_en: 'LPN code must be 1-64 characters'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_STATUS_INVALID
    module: M1
    category: LPN
    detail: STATUS_INVALID
    http_status: 422
    severity: warning
    message_zh: 'LPN 容器状态非法'
    message_en: 'LPN container status is invalid'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_NUMBERING_UNAVAILABLE
    module: M1
    category: LPN
    detail: NUMBERING_UNAVAILABLE
    http_status: 422
    severity: error
    message_zh: '该容器类型未配置可用编号规则'
    message_en: 'No numbering rule is available for this container type'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_NOT_FOUND
    module: M1
    category: LPN
    detail: NOT_FOUND
    http_status: 404
    severity: error
    message_zh: 'LPN 容器不存在'
    message_en: 'LPN container was not found'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_PERSIST_FAILED
    module: M1
    category: LPN
    detail: PERSIST_FAILED
    http_status: 500
    severity: error
    message_zh: 'LPN 容器持久化失败'
    message_en: 'Failed to persist LPN container'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_IDEMPOTENCY_REQUIRED
    module: M1
    category: LPN
    detail: IDEMPOTENCY_REQUIRED
    http_status: 400
  ...
  - code: M1_LPN_IDEMPOTENCY_CONFLICT
    module: M1
    category: LPN
    detail: IDEMPOTENCY_CONFLICT
    http_status: 409
    severity: warning
    message_zh: '幂等键已被不同请求使用'
    message_en: 'Idempotency-Key was already used by a different request'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_BATCH_COUNT_INVALID
    module: M1
    category: LPN
    detail: BATCH_COUNT_INVALID
    http_status: 422
    severity: warning
    message_zh: '批量新增数量必须为 1-100'
    message_en: 'LPN batch create count must be 1-100'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M1_LPN_NOT_DELETABLE
    module: M1
    category: LPN
    detail: NOT_DELETABLE
    http_status: 422
    severity: warning
    message_zh: '在用或作业中的容器不能删除，请先解绑'
    message_en: 'In-use LPN container cannot be deleted until unbound'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25
  ...
  - code: M2_ASN_DUPLICATE
    ...
    introduced_in: v3.1
  - code: M1_QUALITY_LOCK_STATE_INVALID
    module: M1
    category: QUALITY_LOCK
    detail: STATE_INVALID
    http_status: 422
    severity: error
    message_zh: '容器状态非 in_use，禁止加锁'
    message_en: 'Container is not in_use, lock forbidden'
    related_fields: []
    related_stories: [US-M1-004b]
    introduced_in: v26
  - code: M1_QUALITY_LOCK_WITNESS_INVALID
    module: M1
    category: QUALITY_LOCK
    detail: WITNESS_INVALID
    http_status: 422
    severity: error
    message_zh: '见证人缺失或与操作人相同，双人见证不成立'
    message_en: 'Witness missing or same as operator'
    related_fields: []
    related_stories: [US-M1-004b]
    introduced_in: v26
  - code: M1_QUALITY_LOCK_MQL_NOT_FINAL
    module: M1
    category: QUALITY_LOCK
    detail: MQL_NOT_FINAL
    http_status: 409
    severity: error
    message_zh: '关联 M-QL 未办结（closed/rejected），禁止解锁'
    message_en: 'M-QL not final (closed/rejected), release forbidden'
    related_fields: []
    related_stories: [US-M1-004b]
    introduced_in: v26
  - code: M1_QUALITY_LOCK_ZONE_MISMATCH
    module: M1
    category: QUALITY_LOCK
    detail: ZONE_MISMATCH
    http_status: 422
    severity: error
    message_zh: '目标库区质量分区与锁类别不匹配'
    message_en: 'Target zone quality_color mismatches lock category'
    related_fields: []
    related_stories: [US-M1-004b]
    introduced_in: v26
  - code: M1_QUALITY_LOCK_LOCATION_TYPE_INVALID
    module: M1
    category: QUALITY_LOCK
    detail: LOCATION_TYPE_INVALID
    http_status: 422
    severity: error
    message_zh: '加锁容器目标位非存储位（禁上箱拣/零拣位）'
    message_en: 'Locked container target must be storage location'
    related_fields: []
    related_stories: [US-M1-004b]
    introduced_in: v26
  ...
  - code: M1_BIND_LOCATION_MISMATCH
    module: M1
    category: DEVICE_BIND
    detail: LOCATION_MISMATCH
    http_status: 422
    severity: error
    message_zh: '库位不存在或不属于设备所在仓库'
    message_en: 'Location does not exist in the device warehouse'
    related_fields: [location_id, warehouse_id]
    related_stories: [US-M1-010]
    introduced_in: v3.16
  ...
  - code: M1_DEVICE_INTERNAL
    ...
    severity: error
    message_zh: '设备中台内部错误'
    message_en: 'Device platform internal error'
    related_fields: []
    related_stories: [US-M1-010]
    introduced_in: v3.14
  ...
  - code: M1_DEVICE_INVALID_REQUEST
    module: M1
    category: DEVICE
    detail: INVALID_REQUEST
    http_status: 400
    severity: error
    message_zh: '设备中台请求路径、查询参数或 JSON 正文非法'
    message_en: 'Device platform request path, query, or JSON body is invalid'
    related_fields: []
    related_stories: [US-M1-010]
    introduced_in: v3.17
  ...
  - code: M2_PUTAWAY_ZONE_CATEGORY_DENIED
    module: M2
    category: PUTAWAY
    detail: ZONE_CATEGORY_DENIED
    http_status: 403
    severity: error
    message_zh: '商品品类与目标库区准入大区不匹配（6 维①）'
    message_en: 'Product category denied by target zone'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v26
  - code: M2_PUTAWAY_TEMPERATURE_MISMATCH
    module: M2
    category: PUTAWAY
    detail: TEMPERATURE_MISMATCH
    http_status: 422
    severity: error
    message_zh: '目标库位温区不满足商品存储温区要求（6 维②）'
    message_en: 'Target zone temperature mismatches product requirement'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v26
  - code: M2_PUTAWAY_QUALITY_LOCKED
    module: M2
    category: PUTAWAY
    detail: QUALITY_LOCKED
    http_status: 409
    severity: error
    message_zh: '容器质量锁/批次状态非合格，禁止上架合格位（6 维③）'
    message_en: 'Container quality lock or batch status not qualified'
    related_fields: []
    related_stories: [US-M2-005, US-M1-004b]
    introduced_in: v26
  - code: M2_PUTAWAY_SPECIAL_DUAL_REQUIRED
    module: M2
    category: PUTAWAY
    detail: SPECIAL_DUAL_REQUIRED
    http_status: 422
    severity: error
    message_zh: '特药上架需要双人核验（6 维④）'
    message_en: 'Special drug putaway requires dual verification'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v26
  - code: M2_PUTAWAY_PACK_GRANULARITY_INVALID
    module: M2
    category: PUTAWAY
    detail: PACK_GRANULARITY_INVALID
    http_status: 422
    severity: error
    message_zh: '包装粒度与目标位作业形态不符（6 维⑤）'
    message_en: 'Pack granularity invalid for target location type'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v26
  - code: M2_PUTAWAY_EXTERNAL_FRAGRANT_CONFLICT
    module: M2
    category: PUTAWAY
    detail: EXTERNAL_FRAGRANT_CONFLICT
    http_status: 422
    severity: error
    message_zh: '外用/易串味商品与目标库区互斥（6 维⑥）'
    message_en: 'External-use or fragrant product conflicts with target zone'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v26
  - code: M2_PUTAWAY_CAPACITY_EXCEEDED
    module: M2
    category: PUTAWAY
    detail: CAPACITY_EXCEEDED
    http_status: 422
    severity: error
    message_zh: '目标库位剩余容量不足（6 维⑥）'
    message_en: 'Target location remaining capacity exceeded'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v26
  - code: M2_LPN_NOT_FOUND
    module: M2
    category: PUTAWAY
    detail: LPN_NOT_FOUND
    http_status: 422
    severity: error
    message_zh: '上架填写的 LPN 在容器主档中不存在'
    message_en: 'Putaway LPN is not found in container master'
    related_fields: []
    related_stories: [US-M1-004]
    introduced_in: v25

  - code: M2_LPN_BINDNG_FAILED
    module: M2
    category: PUTAWAY
    detail: LPN_BINDNG_FAILED
    http_status: 422
    severity: error
    message_zh: 'LPN 当前状态或库位不可用于上架绑定'
    message_en: 'LPN is not usable for putaway binding'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v25

  - code: M2_LPN_MIX_DENIED
    module: M2
    category: PUTAWAY
    detail: LPN_MIX_DENIED
    http_status: 422
    severity: warning
    message_zh: '该容器类型不允许混批或混品上架'
    message_en: 'Container type policy forbids mixed SKU or batch putaway'
    related_fields: []
    related_stories: [US-M2-005]
    introduced_in: v25
  ...
  - code: M3_REPLENISH_STRATEGY_NOT_FOUND
    module: M3
    category: REPLENISH
    detail: STRATEGY_NOT_FOUND
    http_status: 404
    severity: warning
    message_zh: '补货策略不存在'
    message_en: 'Replenishment strategy was not found'
    related_fields: []
    related_stories: [US-M3-012]
    introduced_in: v3.13

  - code: M3_REPLENISH_GROUP_NOT_FOUND
    module: M3
    category: REPLENISH
    ...
    severity: warning
    message_zh: '补货库位组不存在'
    message_en: 'Replenishment location group was not found'
    related_fields: []
    related_stories: [US-M3-012]
    introduced_in: v3.13
  ...
  - code: M3_REPLENISH_WAVE_GAP
    ...
    http_status: 422
    severity: warning
    message_zh: '波次补货缺口生成失败'
    message_en: 'Wave replenishment gap generation failed'
    related_fields: []
    related_stories: [US-M3-012]
    introduced_in: v3.13
...
| 2026-08-20 | v3.16 | 登记设备绑定库位/仓库不一致 `M1_BIND_LOCATION_MISMATCH`；脚本统计当前合计 254 项 |
| 2026-08-20 | v3.17 | 登记设备中台统一请求提取错误 `M1_DEVICE_INVALID_REQUEST`；脚本统计当前合计 255 项 |
