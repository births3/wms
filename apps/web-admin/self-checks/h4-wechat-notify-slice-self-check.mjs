...
assert.match(pageSource, /(?:<QueryPanel[\s\S]*fields=|queryFields=)\{h4WechatSettingsQueryFields\}/, "H4 参数设置必须使用公共 QueryPanel");
...
assert.match(pageSource, /(?:<QueryPanel[\s\S]*fields=|queryFields=)\{h4NotificationConfigQueryFields\}/, "H4 通知配置必须使用公共 QueryPanel");
assert.match(pageSource, /(?:<QueryPanel[\s\S]*fields=|queryFields=)\{h4NotificationRecordQueryFields\}/, "H4 发送记录必须使用公共 QueryPanel");
...
assert.match(pageSource, /(?:<DataGrid[\s\S]*storageKey="|storageKey:\s*")h4\.wechat-notify\.settings"/, "H4 参数设置必须使用公共 DataGrid");
assert.match(pageSource, /(?:<DataGrid[\s\S]*storageKey="|storageKey:\s*")h4\.wechat-notify\.configs"/, "H4 通知配置必须使用公共 DataGrid");
assert.match(pageSource, /(?:<DataGrid[\s\S]*storageKey="|storageKey:\s*")h4\.wechat-notify\.records"/, "H4 发送记录必须使用公共 DataGrid");
