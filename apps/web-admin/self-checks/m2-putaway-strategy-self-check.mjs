...
assert.match(page, /(?:<DataGrid\b|<ListPageTemplate\b)/, "上架策略页必须使用公共 DataGrid 或 ListPageTemplate");
assert.match(page, /(?:<QueryPanel\b|<ListPageTemplate\b)/, "上架策略页必须使用公共 QueryPanel 或 ListPageTemplate");
