...
assert.match(page, /(?:<QueryPanel\b|<ListPageTemplate\b)/, "H1 会话页必须使用 QueryPanel 或 ListPageTemplate");
assert.match(page, /(?:<DataGrid\b|<ListPageTemplate\b)/, "H1 会话页必须使用 DataGrid 或 ListPageTemplate");
