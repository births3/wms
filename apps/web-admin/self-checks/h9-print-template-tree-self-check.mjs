...
assert.match(pageSource, /createAction[=:]\s*\{?canWriteTemplate \? createAction : undefined\}?/);
assert.match(pageSource, /editAction[=:]\s*\{?canWriteTemplate \? editAction : undefined\}?/);
assert.match(pageSource, /disableAction[=:]\s*\{?canWriteTemplate \? disableAction : undefined\}?/);
assert.match(pageSource, /toolbarActions[=:]\s*\{?toolbarActions\}?/);
