...
const documentDevMock = read("dev-mocks/drug-inspection-document-dev-mock.ts");
...
assert.match(devMock, /handleDrugInspectionDocumentDevMock/);
assert.match(documentDevMock, /\/api\/v1\/drug-inspection\/inbound-documents/);
assert.match(documentDevMock, /\/api\/v1\/attachments\/uploads/);
assert.match(documentDevMock, /upstream-delivery-document-versions/);
