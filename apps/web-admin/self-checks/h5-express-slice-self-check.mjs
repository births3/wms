...
assert.match(pageSource, /QueryPanel|<ListPageTemplate/, "H5 快递对接必须使用公共查询组件");
...
const carriersGridStart = pageSource.indexOf('storageKey: "h5.express.carriers"') !== -1 ? pageSource.indexOf('storageKey: "h5.express.carriers"') : pageSource.indexOf('storageKey="h5.express.carriers"');
