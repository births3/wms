...
assert.match(viteConfig, /pathname === "\/api\/v1\/inventory\/batches"/, "开发 mock 应覆盖 M3 批号列表路由");
assert.match(viteConfig, /function devSeedInventoryBatches\(\)/, "开发 mock 应提供 M3 批号列表数据");
