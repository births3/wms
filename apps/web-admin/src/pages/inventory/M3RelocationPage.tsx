...
export function M3RelocationPage() {
  ...
  return (
    <ListPageTemplate
      queryFields={m3RelocationQueryFields}
      coreQueryFieldKeys={m3RelocationCoreQueryFieldKeys}
            ...
            >
              ...
              <label className="grid gap-1 text-sm">
                ...
                <Input
                  aria-label="目标库位编码"
                  required
                  value={form.to_location_code}
                  onChange={(e) => setForm({ ...form, to_location_code: e.target.value })}
                />
              </label>
              <label className="grid gap-1 text-sm">
                原因
