  ...
  return (
    <ListPageTemplate
      banner={
        <>
          {risks.length > 0 && (
            <div className="rounded-lg border border-amber-300 bg-amber-50 p-4" aria-label="库位风险识别">
          ...
          {productShares.length > 0 && (
            <div className="rounded-lg border bg-card p-4" aria-label="商品分布">
      ...
      queryFields={m3LocationHistoryQueryFields}
      coreQueryFieldKeys={m3LocationHistoryCoreQueryFieldKeys}
