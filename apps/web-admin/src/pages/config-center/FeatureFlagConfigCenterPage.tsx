...
export function FeatureFlagConfigCenterPage({ onBack }: FeatureFlagConfigCenterPageProps) {
  ...
  return (
    <ListPageTemplate
      ...
      queryFields={featureFlagQueryFields}
      coreQueryFieldKeys={featureFlagCoreQueryFieldKeys}
      queryValue={draftQuery}
      loading={flagsQuery.isPending || flagsQuery.isFetching}
      onQueryValueChange={(next) => setDraftQuery(normalizeFeatureFlagQuery(next))}
