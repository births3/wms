...
export function H5ExpressPage() {
  ...
  return (
    <ListPageTemplate
      ...
      coreQueryFieldKeys={h5ExpressCoreQueryFieldKeys}
      queryValue={query}
      onQueryValueChange={(next) => setQuery(normalizeQuery(next))}
    ...
    >
      <Card className="flex flex-1 flex-col min-h-0 overflow-hidden rounded-lg shadow-sm">
        <CardContent className="flex flex-1 flex-col min-h-0 space-y-4 p-5">
