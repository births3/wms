...
export function DockManagementPage() {
  ...
  return (
    <ListPageTemplate
      notice={notice ? { kind: "info", text: notice } : null}
      banner={
        <>
      ...
      queryFields={dockQueryFields}
      fieldOptions={{ warehouseId: warehouseOptions }}
      coreQueryFieldKeys={dockCoreQueryFieldKeys}
      queryValue={draftQuery}
      loading={docksQuery.isPending || docksQuery.isFetching || warehousesQuery.isPending}
