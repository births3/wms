...
const M1LpnContainerPage = React.lazy(() => import("@/pages/master-data/M1LpnContainerPage").then((m) => ({ default: m.M1LpnContainerPage })));
...
export function renderAdminView(
  ...
  if (view === "m1-lpn-containers") return <M1LpnContainerPage />;
