...
const HAND_BUILT_TABS: TabDef[] = [
  ...
  // M2 采购入库
  { value: "m2-asn", label: "ASN/PC 收货", group: "M2 采购入库", device: ["pc"],
    render: () => wrap(<M2Asn />) },
  { value: "m2-tasks", label: "PDA 任务列表", group: "M2 采购入库", device: ["pda"],
    render: () => wrap(<M2InboundTasks />) },
  { value: "m2-accept", label: "验收工作台", group: "M2 采购入库", device: ["pda", "pc"],
    render: () => wrap(<M2InboundAccept />) },
  { value: "m2-putaway", label: "上架工作台", group: "M2 采购入库", device: ["pda", "pc"],
