...
#[utoipa::path(post, path = "/api/v1/inbound/putaway/validate-location", tag = "inbound", request_body = PutawayLocationValidationRequest, responses((status = 200, description = "上架 6 维前置校验通过", body = PutawayLocationValidationResponse), (status = 401, description = "未登录", body = ErrorResponse), (status = 403, description = "无上架权限", body = ErrorResponse), (status = 422, description = "6 维合规校验拦截", body = ErrorResponse)))]
#[allow(dead_code)]
pub(crate) fn validate_putaway_location() {}

#[utoipa::path(get, path = "/api/v1/inventory/batches", tag = "inventory", params(("q" = Option<String>, Query, description = "商品名称/编码、批号、库位或容器模糊匹配"), ("product_code" = Option<String>, Query, description = "商品编码模糊匹配"), ("batch_no" = Option<String>, Query, description = "批号模糊匹配"), ("location_code" = Option<String>, Query, description = "库位编码模糊匹配"), ("location_type" = Option<String>, Query, description = "库位类型精确匹配"), ("zone_code" = Option<String>, Query, description = "库区编码精确匹配"), ("temperature_zone" = Option<String>, Query, description = "温区精确匹配"), ("status" = Option<String>, Query, description = "质量状态精确匹配"), ("production_from" = Option<String>, Query, description = "生产日期起始日，格式 YYYY-MM-DD"), ("production_to" = Option<String>, Query, description = "生产日期截止日，格式 YYYY-MM-DD"), ("expiry_from" = Option<String>, Query, description = "有效期起始日，格式 YYYY-MM-DD"), ("expiry_to" = Option<String>, Query, description = "有效期截止日，格式 YYYY-MM-DD"), ("created_from" = Option<String>, Query, description = "创建时间起点，RFC3339"), ("created_to" = Option<String>, Query, description = "创建时间终点，RFC3339"), ("page" = Option<u32>, Query, description = "页码，从 1 开始；缺省为 1"), ("page_size" = Option<u32>, Query, description = "每页条数；缺省为 20，上限 200")), responses((status = 200, description = "库存批次列表", body = InventoryBatchListResponse), (status = 401, description = "未登录", body = ErrorResponse)))]
#[allow(dead_code)]
