...
#[utoipa::path(
    ...
    responses((status = 200, description = "升级规则列表", body = AlertEscalationRuleListResponse)),
)]
#[allow(dead_code)]
...
#[utoipa::path(
    ...
    responses((status = 200, description = "GSP 强制告警完整生命周期报表", body = GspAlertLifecycleReport)),
)]
#[allow(dead_code)]
...
#[utoipa::path(
    ...
    responses((status = 200, description = "看板增量变更", body = AlertChangeListResponse)),
)]
#[allow(dead_code)]
