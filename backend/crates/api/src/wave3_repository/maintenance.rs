    ...
    pub async fn list_maintenance_tasks(
        ...
        let rows = sqlx::query_as::<_, MaintenanceTaskRow>(
            ...
            SELECT task.id,
                   ...
                   batch.batch_no,
                   batch.expiry_date,
                   batch.status AS inventory_status,
                   batch.location_id,
                   batch.location_code,
                   task.planned_at,
                   task.status,
            ...
            SELECT batch.id
             ...
             WHERE batch.owner_id = $1
               ...
               AND (
                    ...
                    OR (
                        (
                            COALESCE(product.storage_condition, 'normal_10_30') IN ('freeze_le_minus_20', 'cold_2_8', 'cool_le_20')
                    ...
                    OR (
                        COALESCE(product.storage_condition, 'normal_10_30') NOT IN ('freeze_le_minus_20', 'cold_2_8', 'cool_le_20')
