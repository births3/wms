...
const INVENTORY_BATCHES_LIST_FILTERS: &str = r#"
             WHERE inventory_batches.owner_id = $1
               ...
               AND ($9::TEXT IS NULL OR inventory_batches.status = $9)
    ...
    async fn fetch_inventory_batches_page(
        ...
        let sql = format!(
            ...
            SELECT inventory_batches.id, inventory_batches.owner_id, inventory_batches.product_code,
                   ...
                   inventory_batches.qty_frozen, inventory_batches.status,
                   inventory_batches.qty_allocated,
                   inventory_batches.qty_replenish_in_transit,
                   inventory_batches.qty_replenish_out_transit,
