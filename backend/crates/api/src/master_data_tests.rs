    ...
    use uuid::Uuid;
    use wms_domain::{
        CreateLocationRequest, CreateProductRequest, CreateSupplierRequest,
        ProductPackagingLevelInput, UpdateProductRequest,
            ...
            .create_product(
                ...
                CreateProductRequest {
                    ...
                    packaging_levels: vec![ProductPackagingLevelInput {
                        unit_code: "bag".to_string(),
                        unit_name: "袋".to_string(),
                        ratio_to_base: 1,
                        is_base: true,
                        is_default: true,
                        sort_order: 1,
    ...
    fn location_contract_keeps_zone_grid_and_capacity_fields() {
        ...
        let location = store
            .create_location(
                ...
                CreateLocationRequest {
                    ...
                    current_owner_id: Some(ctx.owner_id),
        ...
        assert_eq!(location.current_owner_id, Some(ctx.owner_id));
