...
impl MasterDataStore {
    pub fn create_product(
        ...
        self.products.create(Product {
            ...
            is_external_use: req.is_external_use.unwrap_or(false),
            is_fragrant: req.is_fragrant.unwrap_or(false),
    ...
    pub fn create_location(
        ...
        self.locations.create(Location {
            ...
            current_owner_id: req.current_owner_id,
            allows_container: req.allows_container.unwrap_or(true),
            mix_product_policy: req
                .mix_product_policy
                .unwrap_or_else(|| "single_product_only".into()),
            mix_batch_policy: req
                .mix_batch_policy
                .unwrap_or_else(|| "single_batch".into()),
            lock_status: req.lock_status.unwrap_or_else(|| "normal".into()),
            pick_zone_level: req.pick_zone_level,
    ...
    pub fn update_location(
        ...
        self.locations.update(ctx.owner_id, id, now, |location| {
            ...
            if let Some(value) = req.current_owner_id {
                location.current_owner_id = Some(value);
            }
            if let Some(value) = req.status {
...
pub(crate) fn validate_product_storage_condition(
    ...
    if matches!(
        value,
        "normal_10_30" | "cool_le_20" | "cold_2_8" | "freeze_le_minus_20" | "ultra_cold_minus_80"
    ) {
        Ok(())
    } else {
