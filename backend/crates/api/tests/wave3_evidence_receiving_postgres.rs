...
async fn seed_receiving_references(
    ...
    let product_id: Uuid = sqlx::query_scalar(
        "INSERT INTO products (id, owner_id, product_code, product_name, specification, storage_condition, status) VALUES ($1, $2, $3, 'Evidence Product', '1 unit', 'normal_10_30', 'active') RETURNING id",
    )
    .bind(Uuid::new_v4())
    .bind(owner_id)
