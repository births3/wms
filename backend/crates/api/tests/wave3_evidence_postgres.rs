...
async fn inbound_chain_persists_inventory_movement_and_audit_end_to_end(pool: PgPool) {
    ...
    sqlx::query("INSERT INTO warehouse_zones (id,owner_id,warehouse_id,zone_code,zone_name,temperature_zone,quality_color,status) VALUES ($1,$2,$3,$4,'链路合格区','normal','qualified_green','active')")
