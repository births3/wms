...
WHERE node.id = '00000000-0000-0000-0000-000000130042'
ON CONFLICT DO NOTHING;
...
WHERE bp.menu_node_id = '00000000-0000-0000-0000-000000130042'
ON CONFLICT DO NOTHING;
