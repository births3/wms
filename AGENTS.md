...
| [docs/adr/0034-wave-3-operational-postgres-schema.md](docs/adr/0034-wave-3-operational-postgres-schema.md) | **Wave 3 PostgreSQL 持久化模型**（M2/M3/M5/M9 首批业务表 + 幂等表 + repository 事务边界；供应商资质有效期来源冻结为 M1 + M-VR）|
